...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="https://rbmarketing.agency/public/images/media/1710324731310458480_476630204516344_5904615978034254611_n.png">
    @yield('styles')
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#0">
                <div class="sidebar-brand-text mx-3">RB Marketing Agency</div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>© 2024. All rights reserved by <a href="https://nerdware.site/" target="blank">Nerdware</a> </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
