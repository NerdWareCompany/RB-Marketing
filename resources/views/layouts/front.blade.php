    ...
    <header class="header">
        ...
        <div class="header__content__venor">
            ...
            <form action="{{ route('search') }}" class="header__search__venor" method="GET">
                <input id="search" type="text" name="term" placeholder="Searh here ..." autocomplete="off">
                ...
                <div class="col-lg-6">
                    <div class="footer-right">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="copyright-text" style="color:#bdbdbd">
                                    © 2024. All rights reserved by <a href="https://nerdware.site/" target="blank">Nerdware  </a> 
                                </div>
                            </div>
                        </div>
                    </div>
