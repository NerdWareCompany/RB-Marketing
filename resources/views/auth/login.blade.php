        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background: url('https://rbmarketing.agency/public/images/media/1710327262310458480_476630204516344_5904615978034254611_n.png'); background-size: 100% 100%"></div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                 ...
                                 <form method="POST" action="{{ route('login') }}" class="user">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-user btn-block" style="background-color: #dcab33; border-color:#dcab33">
                                        {{ __('Login') }}
                                    </button>
